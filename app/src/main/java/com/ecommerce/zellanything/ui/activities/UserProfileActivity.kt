        ...
        if (v != null) {
            when (v.id) {
                ...
                R.id.iv_user_photo -> {
                    ...
                    // Aquí comprobaremos si el permiso ya está permitido o necesitamos solicitarlo.
                    // En primer lugar comprobaremos el permiso READ_EXTERNAL_STORAGE y si no está permitido solicitaremos el mismo.
                    if (ContextCompat.checkSelfPermission(
                        ...
                        /*Solicita que se otorguen permisos a esta aplicación. Estos permisos
                          deben solicitarse en su manifiesto, no deben otorgarse a su aplicación,
                          y deben tener nivel de protección*/
