...
class AddEditAddressActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(mAddressDetails != null){
            if (mAddressDetails!!.id.isNotEmpty()){
                ...
                tv_title_add_edit.text = resources.getString(R.string.title_edit_address)
    ...
    /**
     * función para validar las entradas de la dirección.
     */
    ...
    /**
     * función para guardar la dirección  en la nube.
     */
    private fun saveAddressToFirestore() {

        // Aquí obtenemos el texto de editText y recortamos el espacio
    ...
    // TODO Paso 3: Cree una función para notificar el resultado exitoso de la dirección guardada.
    // START
